...
<body class='bg-secondary'>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand text-warning" href="index.php">{Stynger}</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active text-danger" aria-current="page" href="admin.php">Home</a>
    
            <li class="nav-item">
              <a class="nav-link text-danger" href="analitycs.php">Link</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item text-warning" href="chat/main.php">Chat</a></li>
